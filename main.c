...
int main(void) {
  Task *tlist[100];
  Task t1,t2,t3;
  strcpy(t1.title ,"Project1"); strcpy(t1.due_date, "20230525");
  ...
  strcpy(t2.title ,"Project2"); strcpy(t2.due_date, "20230526");
  ...
  strcpy(t3.title ,"Project3"); strcpy(t3.due_date, "20230527");
